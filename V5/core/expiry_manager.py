...
from utils.helpers import get_nearest_strike
...
class ExpiryManager:
    def __init__(self, kite, order_manager, spot_price):
        ...
        self.min_strike_distance = ADJACENCY_GAP * 2  # Minimum distance from spot
    ...
    def _get_initial_expiries(self):
        ...
        return {
            ...
            'far_month': monthly_expiries[3] if len(monthly_expiries) > 3 else monthly_expiries[-1]
        }
    ...
    def _get_safe_strike(self, expiry):
        ...
        base_strike = get_nearest_strike(self.spot)
        candidates = sorted(
            self.instruments[
